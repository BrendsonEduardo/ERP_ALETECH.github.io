...
urlpatterns = [
    ...
    # 3. Cadastro e API de Oportunidades (Kanban Drag and Drop)
    ...
    path('oportunidade/<int:id>/', views.detalhe_proposta, name='detalhe_proposta'),
    path('oportunidade/<int:id>/editar/', views.editar_proposta, name='editar_proposta'),
    path('oportunidade/<int:id>/teste/', views.gerenciar_teste, name='gerenciar_teste'),
    ...
    # Central Unificada de Relatórios (Corrigido sem duplicados)
