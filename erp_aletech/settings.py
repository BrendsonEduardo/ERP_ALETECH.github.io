...
SECRET_KEY = 'django-insecure-ra@*_%n&hbb093h4!m((1--yr&)0h2olt(1hko2h!smk10az2#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Permite o seu IP atual, localhost e o coringa '*' para evitar travamentos se o roteador mudar seu IP
ALLOWED_HOSTS = ['192.168.15.16', '127.0.0.1', 'localhost', '*']
...
# Internationalization (Ajustado para Português e Fuso Horário local)
